...
write.table(output_all,file = "/Users/qiyan/Dropbox/Horvath_Lab/Onging_Project/Aging_Gene_local/Enrichment_Analysis_Results/TWASEWAS_enriched_results_maxlifespan.csv",sep=',',row.names = F,quote=F)
...
png(file="/Users/qiyan/Dropbox/Horvath_Lab/Onging_Project/Aging_Gene_local/Enrichment_Analysis_Results/TWASEWAS_enriched_results_maxlifespan.png", width=1600, height=1400)
